...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.section_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.section_edit.setObjectName("section_edit")
        self.horizontalLayout_4.addWidget(self.section_edit)
        self.task_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.task_edit.setObjectName("task_edit")
        self.horizontalLayout_4.addWidget(self.task_edit)
        self.verticalLayout.addLayout(self.horizontalLayout_4)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.addRootSection = QtWidgets.QPushButton(self.centralwidget)
        self.addRootSection.setObjectName("addRootSection")
        self.horizontalLayout_2.addWidget(self.addRootSection)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addRootSection.setText(_translate("MainWindow", "+Корневой раздел"))
